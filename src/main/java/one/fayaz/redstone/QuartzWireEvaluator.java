...
public abstract class QuartzWireEvaluator {
    protected final QuartzDustBlock wireBlock;

    protected QuartzWireEvaluator(final QuartzDustBlock wireBlock) {
...
//        Double resistance means lose 2 per block
        return Math.max(0, wireSignal - 2);
    }
}
